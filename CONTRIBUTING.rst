...
webhooks could always use more documentation, whether as part of the 
official webhooks docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.6, 2.7, and 3.3, and for PyPy. Check 
   https://travis-ci.org/pydanny/webhooks/pull_requests
